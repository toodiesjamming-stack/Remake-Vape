...
scarcitybanner.Text = 'SKIDV4 - skid at your own risk :D'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/toodiesjamming-stack/Remake-Vape/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
